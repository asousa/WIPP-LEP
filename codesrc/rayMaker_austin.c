/*
 *  Austin's edited version of makeMultipleNewrayInC_smoothLK6.c
 *    - Getting rid of some command-line inputs; using consts.h
 *        file instead. 
 *
 *
...
int main(int argc, char *argv[] )
{
  ...
  LAT_SPREAD  = atof(argv[6]);
  final_TG	= atof(argv[6]);
  LAT_SPREAD	= atof(argv[7]);
  //final_TG = RAYTRACE_TIME;
